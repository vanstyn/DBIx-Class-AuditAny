...
# t/003_record_different_schema.t - test logging changes to a separate schema
...
ok(
	my $audit_schema = DBICx::TestDatabase->new('TestSchema::One'),
	"Initialize Test Audit Database"
);
...
is(
	$audit_schema->resultset('AuditChange')->search_rs({
		'changeset.client_ip' => $client_ip
	},{
		join => 'changeset'
